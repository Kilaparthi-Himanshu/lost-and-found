...
export const Search = () => {
    ...
    return (
        <div className='bg-neutral-200 h-10 my-auto w-[300px] md:w-[500px] lg:w-[600px] rounded-3xl flex items-center justify-center p-3 hover:bg-sky-200 focus-within:border-2 focus-within:border-sky-500 border-2 border-transparent transition-[background,border]'>
            <form onSubmit={(e) => {
                e.preventDefault();
