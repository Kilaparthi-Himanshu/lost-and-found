...
export const MyPost = ({ post }: PostProps) => {
    ...
    return (
        <div className='border border-neutral-400 h-full w-full rounded-lg p-2 flex max-xl:flex-col gap-2 bg-neutral-100 hover:bg-sky-100 cursor-pointer transition-[background]' onClick={handleClick}>
            <img
