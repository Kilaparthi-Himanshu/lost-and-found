...
export const MyPostsLoadingSkeleton = () => {
    return (
        <>
            <div className='border border-neutral-400 dark:bg-neutral-900 dark:border-neutral-600 h-full w-full rounded-lg p-2 flex max-xl:flex-col gap-2 bg-neutral-100 cursor-pointer transition-[background]'> 
                <div
                ...
                <div className='border border-neutral-400 dark:bg-neutral-900 dark:border-neutral-600 flex-1 rounded-lg max-sm:py-2 p-4 font-medium flex flex-col h-full text-lg justify-between gap-2'>
            ...
            <div className='border border-neutral-400 dark:bg-neutral-900 dark:border-neutral-600 h-full w-full rounded-lg p-2 flex max-xl:flex-col gap-2 bg-neutral-100cursor-pointer transition-[background]'> 
                <div
